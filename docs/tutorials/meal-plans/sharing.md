...
description: Share meal plans with other RecipeSage users or export via iCal link. Collaborate on meal planning with family and friends.
---
...
To share a new meal plan, head to the [📱 Meal Plans](https://recipesage.com/app/meal-planners) page.
...
To share an existing meal plan, head to the [📱 Meal Plans](https://recipesage.com/app/meal-planners) page.
...
First, head to the [📱 Meal Plans](https://recipesage.com/app/meal-planners) page.
